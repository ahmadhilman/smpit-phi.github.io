  ...
  <div class="content-wrapper">
   ...
   <div class="content">
        <div class="container-fluid">
          <?= form_open_multipart('admin/siswa/ubah/'.$nisn); ?>
          <div class="row">
            <div class="col-lg-12">
    <div class="col-lg-12 col-md-15"> <center> 
      <img src="<?= base_url('assets/img/siswa/'.$image) ?>" class="img-circle elevation-2 mb-3" alt="User Image" width="120px"></center>
              <div class="card">
                  ...
                  <table class="table table-hover">
                      ...
                      <tr><td>Tempat tinggal</td><td>                                    
                        ...
                        <option><?= $tpt_tgl ?></option>
                              ...
                              <tr>
                                <td>Foto</td><td><input type="file" name="image"></td>
                              </tr>
