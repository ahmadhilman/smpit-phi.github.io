 ...
 <table id="example1" class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">Jenis Pengajar</th>
        ...
        <div class="modal-content">
           ...
           <input type="radio"name="jk"value="laki-laki">laki-laki           <input type="radio"name="jk"value="perempuan">perempuan
            <?= form_error('jk', '<small class="text-danger pl-3">', '</small>'); ?> </div> </div> 
                    ...
                    <div class="col-sm-10"> 
           <input type="radio"name="level" value="guru">Guru           <input type="radio"name="level"value="ustadz">Ustadz
            <?= form_error('level', '<small class="text-danger pl-3">', '</small>'); ?> </div>
                    <div class="form-group">
