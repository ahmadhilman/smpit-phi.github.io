                ...
                <tbody>
                    ...
                    foreach ($jabatan as $a) { ?>
                        <tr>
                            <th scope="row"><?= $i++; ?></th>
                            <td><?= $a['jabatan']; ?></td>
                        <td> <a href="<?= base_url('admin/jabatan/ubahJabatan/').$a['id'];?>">                    <div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div></a>
               <a href="<?= base_url('admin/jabatan/hapusJabatan/').$a['id'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.' '.$a['jabatan'];?> ?');">
