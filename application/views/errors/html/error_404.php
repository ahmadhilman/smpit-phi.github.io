...
<head>
  ...
  <title>DISKOMINFO - Page Not Found - 404</title>
  ...
  <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="text-center mt-4">
            ...
            <p class="lead text-gray-800 mb-4">Halaman Yang Anda Cari Tidak Di Temukan</p>
            <p class="text-gray-500 mb-0">Harap Kembali Lagi Ke Home...</p>
            <span class="btn btn-info mb-3" onclick="window.history.go(-1)">Kembali</span> 
          </div>
